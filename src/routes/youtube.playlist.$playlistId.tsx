      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-border/80 shadow-sm mb-8 flex flex-col md:flex-row gap-6 items-start">
          <div className="relative w-full md:w-72 aspect-video rounded-2xl overflow-hidden bg-black shrink-0 border border-border/80 shadow-md">
            ...
            <div className="absolute bottom-3 right-3 px-2.5 py-1 rounded-md bg-black/85 text-white text-xs font-medium flex items-center gap-1.5 backdrop-blur-xs">
          ...
          <div className="flex-1 min-w-0">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 text-amber-800 text-xs font-medium uppercase tracking-wider mb-2">
            ...
            <div className="mt-5 pt-4 border-t border-border/60 flex flex-wrap items-center gap-4 text-xs text-muted-foreground">
              <span className="font-medium text-ink">Varsha Tutorials • Joshi's Academy</span>
              <span>•</span>
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-border/80 shadow-sm">
          <h2 className="text-xl font-semibold text-ink mb-6 flex items-center justify-between">
          ...
          <div className="divide-y divide-border/60">
            {videos.map((vid, idx) => {
              ...
              return (
                ...
                >
                  <span className="font-mono font-medium text-sm sm:text-base text-muted-foreground group-hover:text-[#35208f] w-8 text-center shrink-0">
                    {formattedIdx}
                  </span>
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-sm sm:text-base text-ink group-hover:text-[#35208f] transition-colors line-clamp-2">
                      {vid.title}
                    </h3>
                    {vid.description && (
                  ...
                  <button
                    type="button"
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#35208f]/10 text-[#35208f] font-medium text-xs group-hover:bg-[#35208f] group-hover:text-white transition-colors shrink-0"
                  >
                    <span>Play</span>
